...
import { MusicCat } from '../componentsDesing/MusicCat';
               ...
               style={styles.container}>
                   ...
                   <ScrollView style={{flex:1,width:'100%'}}>
                      ...
                      <View style={styles.section2}>
                        <Image source={{uri:'https://cdn.pixabay.com/photo/2017/01/11/10/25/headsets-1971383_1280.jpg'}}
                   ...
                   <TouchableOpacity style={styles.floatingRep} onPress={()=>{setReproducer(true)}}>
                        <View style={styles.floatingImg}>
                            <Image source={require('../../../assests/song2.jpg')}
